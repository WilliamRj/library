    ...
    <div class="container d-flex justify-content-center">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="/autor/cadastro" class="nav-link px-2 text-secondary">Gerenciar Autor</a></li>
...
<div class="container" id="containerInicial">
		...
		<h2>Editar o autor: ${autor.nome} ${autor.sobrenome}</h2>

		<form action='<c:url value="/autor/salvar" /> ' method="post">
		...
		<input type="hidden" name="codigo_autor" value="${autor.codigo_autor}" >
			...
			<div class="form-group">
				...
				<input
					...
					placeholder="Informe o nome do autor" name="nome" value="${autor.nome}" required>
			...
			<div class="form-group">
				...
				<input
					...
					placeholder="Informe o sobrenome do autor" name="sobrenome" value="${autor.sobrenome}" required>
			...
			<a  class="btn btn-secondary" href='<c:url value="/autor/cadastro/" />' >			
