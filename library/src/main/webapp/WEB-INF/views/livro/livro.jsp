...
<div class="container" id="containerInicial">
		...
		<div class="d-flex justify-content-between">
			...
			<div class="d-flex justify-content-end">
				...
				<h3>
					<a class="btn btn-primary" href='<c:url value="/livro/cadastro/formA" /> ' > Cadastrar autor</a>&nbsp;
				</h3>
				<h3>
					<a class="btn btn-primary" href='<c:url value="/livro/cadastro/formC" /> ' > Cadastrar categoria</a>
				</h3>
			</div>
		</div>
