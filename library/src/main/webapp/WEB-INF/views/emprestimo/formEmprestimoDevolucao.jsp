...
<div class="container" id="containerInicial">
		...
		<form action='<c:url value="/emprestimo/salvarD" /> ' method="post">
		...
		<div class="form-group">
				...
				<input
					type="hidden" class="form-control" id="dataIniEmprestimo"
			...
			<div class="form-group">
				...
				<input
					type="hidden" class="form-control" id="dataFimEmprestimo"
			...
			<div class="form-group">
				...
				<input
					type="date" class="form-control" id="dataRetornada"
			...
			<div class="form-group">
				...
				<input
					...
					placeholder="Informe a multa" name="multa" value="${emprestimo.multa}">
