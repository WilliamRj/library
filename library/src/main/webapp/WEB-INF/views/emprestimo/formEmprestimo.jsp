		...
		<form action='<c:url value="/emprestimo/salvar" /> ' method="post">
			...
			<div class="form-group" style="width:200px">
				...
				<input
					...
					placeholder="Informe a data inicial de emprestimo" name="dataIniEmprestimo" required>
			...
			<div class="form-group" style="width:200px">
				...
				<input
					...
					placeholder="Informe a data final de emprestimo" name="dataFimEmprestimo" required>
			...
			<div class="form-group">
				...
				<input
					...
					placeholder="Informe a data de retornada do emprestimo" name="dataRetornada">
